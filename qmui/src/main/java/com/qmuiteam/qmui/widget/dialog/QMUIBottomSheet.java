...
public class QMUIBottomSheet extends Dialog {
    ...
    public static class BottomGridSheetBuilder implements View.OnClickListener {
        ...
        private QMUICalculateStrategy strategy;
        ...
        private QMUICalculateStrategy getCalculateStrategy() {
            return strategy;
        }

        public BottomGridSheetBuilder setCalculateStrategy(QMUICalculateStrategy strategy) {
...
//            int itemWidth = calculateItemWidth(width, maxItemCountEachLine, firstLine.getPaddingLeft(), firstLine.getPaddingRight());
            int itemWidth = getCalculateStrategy().calculateItemWidth(width, maxItemCountEachLine, firstLine.getPaddingLeft(), firstLine.getPaddingRight());
        ...
        public interface QMUICalculateStrategy {
            int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight);
        }
    }
}
